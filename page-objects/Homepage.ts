...
export class HomePage  {
 ...
 async visitHomepage() {
    ...
    await this.page.goto('https://panda-helsinki-citybike-website.onrender.com/')
...
async checkHomepageTitle(){
   ...
   await expect(this.homepageTitle).toHaveText('Welcome to my Panda Helsinki Citybike website!')
}
